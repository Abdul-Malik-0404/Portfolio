    ...
    <>
      <section id="contact" className="section section-reveal">
        ...
        <div className="grid-2-col" style={{ marginBottom: '3rem' }}>
          <div className="ref-card glass-card hover-glow">
            <h4 style={{ fontSize: '1.2rem', marginBottom: '0.2rem' }}>Ms. Azmiya Cassim</h4>
            <p style={{ color: 'var(--accent-1)', fontSize: '0.9rem', marginBottom: '0.1rem' }}>Assistant Lecturer</p>
        ...
        <div className="contact-footer glass-card hover-glow" style={{ textAlign: 'center', background: 'linear-gradient(135deg, rgba(30, 41, 59, 0.6), rgba(15, 23, 42, 0.8))' }}>
